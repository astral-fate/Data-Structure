...
public class MSLL<T> {
        ...
        while (choice != 13) {
            ...
            switch (choice) {
                ...
                case 11:
                    ...
                    String city11a = scanner.next();
                    System.out.print("Enter city name 2: ");
                    String city11b = scanner.next();
                    double distance = getDistance(city11a, city11b);
                    System.out.println("Distance between " + city11a + " and " + city11b + ": " + distance);
                    break;
                case 12:
                    System.out.print("Enter city name: ");
    ...
    private double getDistance(String city11a, String city11b) {
        // Your implementation to calculate the distance between two cities
        return 0.0;
    }
...
public void addCityToSublistAtPosition(T city, String sublistKey, int position) {
    ...
    private void displayMenu() {
        ...
        System.out.println("1. Add node to MSLL at head");
        System.out.println("2. Add node to MSLL at tail");
        ...
        System.out.println("11. Get distance between cities");
